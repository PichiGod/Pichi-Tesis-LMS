...
function Register() {
    ...
    $query = "INSERT INTO usuario (identificacion_user, nombre_user, apellido_user, correo_user, contrasena_user, direccion_user, numero_user, fecha_nacimiento_user, sexo_user, Empresa_id_empresa ) 
              VALUES ('$rifUsuario', '$nombreUsuario', '$apellidoUsuario', '$correoUsuario', '$contrasenaUsuario', '$direccionUsuario', '$telefonoUsuario', '$fechaNacimientoBD', '$GeneroUsuario', '$idEmpresa')";
