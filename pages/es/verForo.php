...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="/Pichi-Tesis-LMS/assests/css/colorPallete.css"
    />
    ...
    <section>
      <div class="container-fluid bg-blanco my-3 pb-2 shadow">
        ...
        <div class="rounded ">
          <div class="">
            <br />
            <label for="descripcionDiscusion" class="form-label"
              >Contenido de comentario</label
            >
            <textarea
              class="form-control"
              id="descripcionDiscusion"
              rows="3"
            ></textarea>
            <div class="d-flex justify-content-end">
        ...
        <div>
          ...
          <div
            class="container my-3 bg-secondary-subtle rounded text-secondary-emphasis"
          >
            <div
