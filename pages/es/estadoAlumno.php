...
<head>
    ...
    <title>Solvencia Estudiante</title>
    <!-- Bootstrap CSS -->
...
<body class="bg-pastel" id="body-pd">
    ...
    <section>
        <div class="container-fluid bg-blanco my-3 pb-2 shadow">
            ...
            <h1 class="text-center pt-2">Solvencia Estudiante</h1>
            <h4 class="text-center fw-light">Haga click en un registro para seleccionar</h4>
