            ...
            <ul class="dropdown-menu">
              <li class="dropdown-item">
                <span class="fa-solid fa-earth-americas"></span><a class="ms-2 text-body-secondary"
                  href="../es/SeccionInicio.php">Spanish (Latin America)</a>
              </li>
            </ul>
          </div>
          <div class="vr me-2"></div>
          <a name="regis" id="regis" class="btn btn-secundary d-flex shadow me-3" href="registration.php"
            role="button">Register</a>
          <a name="login" id="login" class="btn btn-primary me-4 d-flex shadow" href="#" role="button">Log In</a>
        </div>
      </div>
    </nav>
  </header>
  ...
  <section name="formulario">
    ...
    <div name="formulario" class="bg-pastel">
      <div class="formulario pt-2 px-3 bg-blanco shadow rounded">
        <div>
          <p class="fs-1 text-center">Log In</p>
        </div>
