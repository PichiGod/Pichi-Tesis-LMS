      ...
      <nav class="navbar bg-body-tertiary shadow">
        ...
        <div class="d-flex justify-content-end">
          ...
          <a
            ...
            href="./pages/es/SeccionInicio.php"
            role="button"
            >Iniciar sesión</a
          >
        </div>
    ...
    <div
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img
            src="assests/img/conferencia.jpg"
            class="imagencar d-block w-100"
            alt="..." />
          <div class="carousel-caption">
            <h5>Bienvenido a LMS Pichi</h5>
            <p>LMS Pichi</p>
            <p>
              <a href="./pages/es/iniciarDemo.php" class="btn btn-primary mt-3"
                >Inicie ahora con LMS Pichi</a
              >
            </p>
          </div>
        </div>
        <div class="carousel-item">
          <img
            src="assests/img/conferencia2.jpg"
            class="imagencar d-block w-100"
            alt="..." />
          <div class="carousel-caption">
        ...
        <div class="carousel-item">
          <img
            src="assests/img/conferencia3.avif"
            class="imagencar d-block w-100"
            alt="..." />
          <div class="carousel-caption">
      ...
      <div class="Publicidades">
        <div class="containerPublicidad1">
          <div class="publi1en1">
            <h5 class="parrafoPubli1">
              Tome un paso con nosotros en el futuro en Pichi
              <b class="negritaPubli">Crezca su instituto con nosotros</b>
              <img
                class="imgLogoBlanco"
        ...
        <div class="publicidad2">
          <h6 class="Parrafopubli2">
            Puedes encontrar el mejor LMS at Pichi.com
          </h6>
        </div>
      </div>
    </section>
    ...
    <section>
      <div class="ContainerPreguntas">
        ...
        <div class="preguntas">
          ...
          <div
            class="contenedor-preguntas activo"
